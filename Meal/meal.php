...
<form method="POST">
<div class="w3-col l5" style="margin-left: 300px;">
...
<div class="w3-col l5">
    ...
    <br><input class="w3-button w3-black" name="AddMealSubmit" type="submit" value="Add This Meal" style="margin-top: 5px;">
